...
public class Listado {
    ...
    public Listado() {
        ...
        datos.add(new ListaNintendo(R.drawable.wiiu, "Wii U", "Soy la unica persona que conozco que disfrutó de tener una WII U."));
        ...
        datos.add(new ListaNintendo(R.drawable.gbc, "GameBoy Color", "Pilas no incluidas, pero color si."));
        datos.add(new ListaNintendo(R.drawable.gba, "GameBoy Advance", "Ahora si es una portatil decente."));
